        ...
        <div data-role="header" style="background-color:aliceblue; " id="header">
            ...
            <div class="header_down_part">
                <div class="main_category mob_view">
                    ...
                    <a href="comCat.php?cat=10" class="showRoomLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="roomWrap">
                            <div class="nav nav_homee" style="margin-left: 38px; */">
                                <img src="assets/img/showroom.png" alt="" style="padding:0;">
                            </div>
                            <div class="rbf" style="">শোরুম</div>
                        </div>
                    </a>

                    <a href="comCat.php?cat=9" class="bankLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/bank.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">ব্যাংক</div>
                    </a>

                    <a href="comCat.php?cat=19" class="storeLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/store.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">স্টোর</div>
                    </a>

                    <a href="comCat.php?cat=20" class="factoryLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/factory.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">ফ্যাক্টরি</div>
                    </a>

                    <a href="comCat.php?cat=21" class="hotelLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/hotel.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">হোটেল</div>
                    </a>
                    <a href="comCat.php?cat=22" class="officeLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/office.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">অফিস</div>
                    </a>

                    <a href="comCat.php?cat=23" class="restaurentLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/restaurent.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">রেস্টুরেন্ট</div>
                    </a>

                    <a href="comCat.php?cat=11" class="shopLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/shop.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">দোকান</div>
                    </a>

                    <!--
                    <div style="visibility:hidden;">
                        <a href="comCat.php?cat=2" data-ajax="false" style="cursor:pointer;">
                            <div class="nav nav_carr">
...
-->
                    <!--
                    <a href="comCat.php?cat=1" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
...
">
        ...
        <div data-role="content" class="ui-content contentt" role="main">
            ...
            <a href="comCat.php" id="hrefIdentify"></a>
