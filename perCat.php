        ...
        <div data-role="header" style="background-color:aliceblue; " id="header">
            ...
            <div class="header_down_part">
                <div class="main_category mob_view">
                    ...
                    <a href="perCat.php?cat=29" class="showRoomLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="roomWrap" style="align-items: center;justify-content: center;">
                            <div class="nav" style="">
                                <img src="assets/img/personel.png" alt="" style="padding:0;">
                            </div>
                            <div class="rbf" style="">চুক্তিভিত্তিক নিয়োগ</div>
                        </div>
                    </a>

                    <!--
                    <a href="perCat.php?cat=9" class="bankLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/bank.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">Dozer</div>
                    </a>
                    <a href="comCat.php?cat=9" class="bankLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/bank.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">Loaders</div>
                    </a>
                    <a href="comCat.php?cat=9" class="bankLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/bank.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">Dumpers</div>
                    </a>
-->
...
">
        ...
        <div data-role="content" class="ui-content contentt" role="main">
            ...
            <a href="perCat.php" id="hrefIdentify"></a>
