        ...
        <div data-role="header" style="background-color:aliceblue; " id="header">
            ...
            <div class="header_down_part">
                <div class="main_category mob_view">
                    ...
                    <a href="vehCat.php?cat=6" class="carLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="roomWrap">
                            <div class="nav nav_homee" style="margin-left: 38px; */">
                                <img src="assets/img/carNav.png" alt="" style="padding:0;">
                            </div>
                            <div class="rbf" style="margin-right: 0.355rem;">কার</div>
                        </div>
                    </a>
                    <a href="vehCat.php?cat=8" class="truckLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/truck3.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">ট্রাক</div>
                    </a>
                    <a href="vehCat.php?cat=7" class="busLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                            <img src="assets/img/bus3.png" alt="" style="padding:0;">
                        </div>
                        <div class="rbf">বাস</div>
                    </a>
                ...
                <div class="main_category desktop">
                    ...
                    <a href="vehCat.php?cat=6" class="carLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="roomWrap">
                            ...
                            <div class="rbf" style="margin-right: 0.694rem;">কার</div>
                        </div>
                    </a>
                    <a href="vehCat.php?cat=8" class="truckLocation" data-ajax="false" style="cursor:pointer;">
                        <div class="nav nav_carr">
                    ...
                    <a href="vehCat.php?cat=7" class="busLocation" data-ajax="false" style="cursor:pointer;">
                        ...
                        <div class="rbf" style="margin-left: 12px;">বাস</div>
                    </a>
...
<!--                    flex-basis: 65%;-->
                    ...
                    <div class="ui-btn ui-icon-search ui-btn-icon-right ui-shadow ui-corner-all" id="post_search_subb" style="border: none;background: none;box-shadow: none; margin-top: 1px; margin-left: -8px;
...
">
        ...
        <div data-role="content" class="ui-content contentt" role="main">
            ...
            <div class="userID" style="display:none;" data-userid="<?php echo $userid; ?>"></div>
            <a href="vehCat.php" id="hrefIdentify"></a>
