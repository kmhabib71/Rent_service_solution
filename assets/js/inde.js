   ...
   $(document).ready(function () {
       ...
       if (href == 'homeCat.php') {
           if (loctext != '') {
               $("a.roomLocation").attr("href", "http://localhost/bhara/homeCat.php?cat=3&loc=" + loctext + "");
               $("a.houseLocation").attr("href", "http://localhost/bhara/homeCat.php?cat=2&loc=" + loctext + "");
               $("a.flatLocation").attr("href", "http://localhost/bhara/homeCat.php?cat=1&loc=" + loctext + "");

           }
       } else if (href == 'vehCat.php') {

           if (loctext != '') {
               $("a.carLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=6&loc=" + loctext + "");
               $("a.truckLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=8&loc=" + loctext + "");
               $("a.busLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=7&loc=" + loctext + "");
           ...
           if (loctext != '') {
               $("a.houseLocation").attr("href", "http://localhost/bhara/homeCat.php?loc=" + loctext + "");
               $("a.vehLocation").attr("href", "http://localhost/bhara/vehCat.php?loc=" + loctext + "");
               $("a.comLocation").attr("href", "http://localhost/bhara/comCat.php?loc=" + loctext + "");

           }

       } else if (href == 'comCat.php') {
           if (loctext != '') {
               $("a.showRoomLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=10&loc=" + loctext + "");
               $("a.bankLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=9&loc=" + loctext + "");
               $("a.storeLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=19&loc=" + loctext + "");
               $("a.factoryLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=20&loc=" + loctext + "");
               $("a.hotelLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=21&loc=" + loctext + "");
               $("a.officeLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=22&loc=" + loctext + "");
               $("a.restaurentLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=23&loc=" + loctext + "");
               $("a.shopLocation").attr("href", "http://localhost/bhara/vehCat.php?cat=11&loc=" + loctext + "");
           }
       };
...
// }
           ...
           $(".single_post").on("click", function () {
               ...
               $.post('http://localhost/bhara/core/ajax/postAllFetch.php', {
                   ...
                   if (jsonn[0].userid == userID) {
                       ...
                       $(".det_chat_wr").after("<div class='chatBox' style='display:none;max-height:320px;overflow-y: scroll;padding-top: 1rem;background-color: white;' data-advUserId=" + jsonn[0].userid + " data-userID='" + userID + "' data-advId='" + jsonn[0].adv_id + "'><div class='mainChat'style='border: 1px solid gray;border-radius: 5px;margin: 0 1rem 0rem 1rem; box-shadow: -1px -1px 3px black;'><div class='bothMsgg'><div class='leftMsgText'><div class='leftMsg' style='background-color:lightgray;'>Hi</div><div class='leftMsgTime'></div></div></div><div class='bothMsg'></div><div class='sendBox'><div class='writeMsg' style='border:none;'><input type='text'class='text' style='flex-basis: 80%; border: 1px solid darkseagreen;margin-bottom: 0;    height: 1.5rem;font-size: 0.8rem;Background:white;'id='msgInput'></div><div class='sendMsg' data-userid=" + userID + " data-advid=" + jsonn[0].adv_id + " data-advuserid=" + jsonn[0].userid + ">send</div></div></div></div><div class='closeChat'><div class='closeBtn' style='cursor:pointer;'>close</div></div>");
                   }
               ...
               $(".post_de").html("<div class='fullScr' onload='myLoader()'><div id='loading'></div><div class='det_post'><div class='mainPart'></div> <div class='header_wrapper' style='    width: 100%; position:fixed; z-index:99; height: 2.986rem;'><div class='logo'><div class='back_arrow' style='font-size:42px; text-shadow:none; color:white;'><img src='https://img.icons8.com/metro/50/ffffff/undo.png'></div><a href='http://bhara.com' style='display:none;'><img src='assets/img/logo.svg' alt=''></a></div><a style='text-decoration:none;' href='http://bhara.com'><div class='brandName' style='margin-top: 0.482rem;'>ভাড়া.কম</div></a><a href='#adv' style='display:none;'><div class='post_adv'>Post Adv</div></a><div class='account_icon' style='    visibility: hidden;'><img src='assets/img/account.svg' alt=''></div></div><div class='ad_heading'style='margin-top: 3.8rem;'>" + post_head + "</div><div class='cate'></div><div class='det_area desktop' style=''><div class='det_add' style='margin-left:10px;'> ,</div><div class='det_ps' style='margin-left:10px;'> ,</div><div class='det_dis' style='margin-left:10px;'></div></div><div class='img_det_cont'><div class='store_img' style='display:none;'></div><input type='hidden' id='step' value=''><div class='featured-image-preview'><img src='' class='big-img'><button id='next-img'><div class='next_pic' >❯</div></button><button id='prev-img'><div class='prev_pic'>❮</div></button></div><div class='featured-image-list'></div></div><div class='det_area mob_view' style=''><div class='det_add' style='margin-left:10px;'> ,</div><div class='det_ps' style='margin-left:10px;'> ,</div><div class='det_dis' style='margin-left:10px;'></div></div> <div class='det_feat' style='display:flex;'><div class='det_feat_1' style='margin-left:10px;'></div><div class='det_feat_2' style='margin-left:10px;'></div><div class='det_feat_3' style='margin-left:10px;'></div><div class='det_feat_4' style='margin-left:10px;'></div></div><div class='priceWrap'><div class='det_img_cont'><div class='det_img_cent'></div><div class='negot' style='color:gray;'></div></div></div><div class='part_div' style='margin-bottom:1.2rem;'></div><div class='conWrap'><div class='det_cont_wrap' style='background-color: #158a8f17; width: 100%;'><div class='det_contact'><div class='det_mob'><div class='mob_sym'><img src='../../bhara/assets/img/icons8-outgoing-call-36.png' style='vertical-align: middle;margin-top: 0.482rem;' alt=' style='color: white;width: 32px;'> </div><div class='det_s_mo'></div><div class='det_s_tex' style='cursor:pointer;'>ফোন নাম্বার দেখতে ক্লিক করুন</div></div></div><div class='det_chat_wr' id='unseenMsg'><div class='det_chat'><img src='../../bhara/assets/img/icons8-communication-36.png' style='vertical-align: middle;margin-top: -0.233rem;' alt=' style='color: white;width: 32px;opacity: 0.5;'> </div><div class='det_chat_tex' style='cursor:pointer;'>চ্যাট</div></div><div class='det_mob'><div class='mob_sym'> <img src='../../bhara/assets/img/icons8-customer-36.png' alt=' style='color: white;width: 32px;opacity: 0.5;'></div><div class='det_user' style='font-size:0.81rem;'></div></div></div></div><br ><div class='descWrap' style='width: 100%;: 58%;'><div class='part_div'></div><span style='margin-right: auto;margin-left: 1rem;color: black;font-size: 0.9rem;margin-top: 0.694rem;margin-bottom: 0.694rem;'>বর্ণনা:</span><div class='det_details' style='    padding: 0.482rem 1rem;color: #808080;margin-bottom: 1rem;font-size: 0.694rem;'></div><div class='geocoder'><div id='geocoder'></div></div><div class='mapWrap' style='position:relative; margin-bottom: 1rem;' ><div class='mapClick' style='background-color: white;z-index: 99;overflow:hidden;'></div><div id='map' style=''></div></div><span style='margin-right: auto;margin-left: 1rem;color: black;font-size: 0.9rem;margin-top: 0.694rem;margin-left: 1rem;'> বিজ্ঞাপনটি শেয়ার করুন: </span><div class='adv_shb'></div><span class='onuAdv' style='    margin-right: auto;margin-left: 1rem;color: black;font-size: 0.9rem;margin-top: 0.694rem;margin-bottom: 0.694rem; display:none;'>অনুরূপ বিজ্ঞাপন:</span><div class='relAdvWrap'><span class='rel_adv'></span></div><div class = 'json_store' style = 'display:none;'></div ></div></div></div>");
               var shareButton = '';
       ...
       $('a.dis_design.ui-link').on('click', function () {
           ...
           //         $(this).hide();
           $.post('http://localhost/bhara/core/ajax/category.php', {
               mea: mea,
               nameCat: nameCat
           }, function (data) {
               $('.post').empty();
       ...
       $("#post_search_su").on("click", function () {
               ...
               var loctext = $(".locFind").text();
               $.post('http://localhost/bhara/core/ajax/search.php', {
               ...
               if (get_adv_head == '') {
                   ...
                   if (get_adv_price == '') {
                       ...
                       if (edit_mob_text == '') {
                           ...
                           $.post('http://localhost/bhara/core/ajax/advSub.php', {
       ...
       $("select#select-native-4").on("change", function () {
           ...
           //          //          $("#adv_con").empty();
           //          $.post('http://localhost/bhara/core/ajax/advDetails.php', {
           //              get_cat_val: get_cat_val,
           //
           //          }, function (data) {
           //              $("#disi").html(data);
           //          });
           window.location.href = 'http://localhost/bhara/advCat.php?catVal=' + get_cat_val + '';
       });
       ...
       $("#sel_divi").change(function () {
           ...
           $.post('http://localhost/bhara/core/ajax/divi.php', {
               sel_res: sel_resu,
